...
//        }
    ...
    //интерфейс ITERABLE- обьекти этого класса можна перебирать(итерировать)
    // он имеет метод Iterator<T> iterator()возвращает итератор для коллекции


    //Интерфейс ITERATOR собственно итератор который позволяет обходить коллекцию
    //метод: boolean hasNext()-есть ли следуюющий елемент
    // T next вовращает следуюющий элемент
    // void remove не обязательний удаляет последний возвращенный елемент
